...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoia2hhbmhuZ2FuIiwiYSI6ImNsOGR2dGxkbDBhanMzeHA5cHNyaGh2ZjgifQ.MJIFzbJ-hiHbSzaeDbB4RA';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " updated successfully!")); // window.setTimeout(() => location.reload(), 2500);
            }
...
var bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId, selectedDate) {
    var stripe, url, session;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51LoONOE6k0K4e9ee5vfibtnhXguab91jk5JQYHrNKtc9IoUc4Hcou68cVwgh8Rz5DKhHtmNzfjJRZJRSFJ6ubk1k00invkMgQ1');
            url = "/api/v1/bookings/checkout-session/".concat(tourId, "/").concat(selectedDate); // const url = `/api/v1/bookings/checkout-session/${tourId}/${selectedDate.day}-${selectedDate.month}-${selectedDate.year}`;

            console.log(url); // 1) Get the checkout session from API
...
var date = document.getElementById('selectedDate'); // DELEGATION
